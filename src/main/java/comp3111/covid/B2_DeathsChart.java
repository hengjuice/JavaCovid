...
// Displaying chart showing the cumulative confirmed COVID-19 deaths (per 1M) by country

/*
 
Task B2: Generate data charts showing the cumulative confirmed COVID-19 deaths (per 1M) by country
